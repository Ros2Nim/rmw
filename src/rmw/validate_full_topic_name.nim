...
const
  RMW_TOPIC_VALID* = 0
  RMW_TOPIC_INVALID_IS_EMPTY_STRING* = 1
  RMW_TOPIC_INVALID_NOT_ABSOLUTE* = 2
  RMW_TOPIC_INVALID_ENDS_WITH_FORWARD_SLASH* = 3
  RMW_TOPIC_INVALID_CONTAINS_UNALLOWED_CHARACTERS* = 4
  RMW_TOPIC_INVALID_CONTAINS_REPEATED_FORWARD_SLASH* = 5
  RMW_TOPIC_INVALID_NAME_TOKEN_STARTS_WITH_NUMBER* = 6
  RMW_TOPIC_INVALID_TOO_LONG* = 7
  RMW_TOPIC_MAX_NAME_LENGTH* = 255'u - 8'u


proc rmw_validate_full_topic_name*(topic_name: cstring;
                                   validation_result: ptr cint;
                                   invalid_index: ptr csize_t): rmw_ret_t {.
    importc: "rmw_validate_full_topic_name",
    header: "validate_full_topic_name.h".}
...
proc rmw_validate_full_topic_name_with_size*(topic_name: cstring;
    topic_name_length: csize_t; validation_result: ptr cint;
    invalid_index: ptr csize_t): rmw_ret_t {.
    importc: "rmw_validate_full_topic_name_with_size",
    header: "validate_full_topic_name.h".}
...
proc rmw_full_topic_name_validation_result_string*(validation_result: cint): cstring {.
    importc: "rmw_full_topic_name_validation_result_string",
    header: "validate_full_topic_name.h".}
